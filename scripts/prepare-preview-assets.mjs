...
writeFileSync(
  ...
  [
    ...
    '  <style>body{font-family:"Vazirmatn","Segoe UI",Tahoma,Arial,sans-serif;padding:24px}code{background:#f3f4f6;padding:2px 6px;border-radius:4px}</style>',
    '</head>',
    '<body>',
